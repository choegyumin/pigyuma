...
const packageNames = ['design-system', 'react-utility-types', 'react-utils', 'ui-design-tool', 'utils'];
...
const findResolvedFilePath = (baseDir, targetPath) => {
  ...
  const globPattern = rootDir(baseDir, `${targetPath}${anyExtensionGlobPattern}`);
