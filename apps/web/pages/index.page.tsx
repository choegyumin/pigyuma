...
const dummyData: Array<ArtboardData | ShapeLayerData | TextLayerData> = [
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            layerType: 'text',
            name: '1234',
            x: { length: 10, lengthType: 'px' },
            y: { length: 10, lengthType: 'px' },
            rotate: { degrees: 0 },
            width: { length: 0, lengthType: 'flexible' },
            height: { length: 0, lengthType: 'flexible' },
            textColor: { color: '#000000' },
        ...
        children: [
          {
            ...
            layerType: 'text',
            name: 'ABCD',
            x: { length: 20, lengthType: 'px' },
            y: { length: 20, lengthType: 'px' },
            rotate: { degrees: 0 },
            width: { length: 0, lengthType: 'flexible' },
            height: { length: 0, lengthType: 'flexible' },
            textColor: { color: '#000000' },
      ...
      },
      {
        ...
        name: 'Blue',
        shapeType: 'container',
        x: { length: 700, lengthType: 'px' },
        y: { length: 100, lengthType: 'px' },
        rotate: { degrees: 0 },
        width: { length: 200, lengthType: 'px' },
        height: { length: 400, lengthType: 'px' },
        stroke: { color: '#333333', pattern: 'double', width: { top: 10, right: 10, bottom: 10, left: 10 } },
        fill: { color: '#aaaaff' },
        children: [
          {
            key: 'text-layer-asdf',
        ...
        children: [
          {
            ...
            height: { length: 0, lengthType: 'flexible' },
            textColor: { color: '#000000' },
            fontSize: { length: 24, lengthType: 'px' },
            lineHeight: { length: 150, lengthType: 'percent' },
            fontWeight: { value: 400 },
            letterSpacing: { length: 0, lengthType: 'px' },
            content: 'Inside\r\nartboard',
