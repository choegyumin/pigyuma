...
export enum FontSizeLengthTypeValue {
...
export enum HeightLengthTypeValue {
...
export enum RotateLengthTypeValue {
  deg = NumberUnit.deg,
}
...
export enum LetterSpacingLengthTypeValue {
  percent = NumberUnit.em,
  px = NumberUnit.px,
}
...
export enum LineHeightLengthTypeValue {
  percent = NumberUnit.percent,
  px = NumberUnit.px,
}
...
export enum WidthLengthTypeValue {
  filled = NumberKeyword.stretch,
...
export enum StrokeStylePatternValue {
  solid = 'solid',
  dashed = 'dashed',
  dotted = 'dotted',
  double = 'double',
