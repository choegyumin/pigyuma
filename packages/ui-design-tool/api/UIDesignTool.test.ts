...
describe('UIDesignTool', () => {
  ...
  describe('subscribeItem', () => {
    test('should bind listener and call when record item changes', () => {
      ...
      const unsubscribe = uiDesignTool.subscribeItem(dummyTextLayer.key, listener);
  ...
  describe('subscribeTree', () => {
    test('should bind listener and call when record tree changes', () => {
      ...
      const unsubscribe = uiDesignTool.subscribeTree(listener);
  ...
  describe('subscribeSelection', () => {
    test('should bind listener and call when selection changes', () => {
      const listener = vi.fn<[UIRecord[]], void>();
      const unsubscribe = uiDesignTool.subscribeSelection(listener);
  ...
  describe('mount', () => {
    test('should mount when not already mounted', () => {
      const { unmount } = uiDesignTool.mount();
  ...
  describe('set', () => {
    test('should change UIRecord data', () => {
  ...
  describe('setRect', () => {
    test('should change UIRecord data with rect', () => {
      const shapeLayer = uiDesignTool.get<ShapeLayer>(dummyShapeLayer.key);
